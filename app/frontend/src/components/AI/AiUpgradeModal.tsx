...
export default function AiUpgradeModal({
	...
	return (
		<div className="fixed inset-0 bg-white/70 dark:bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4 transition-all duration-300">
			<Card
				className="max-w-120 w-full border border-border-low bg-surface-glass shadow-2xl relative overflow-hidden"
				padding="lg"
			>
				...
				<div className="flex flex-col items-center text-center gap-5 relative z-10">
					<div className="w-16 h-16 rounded-2xl bg-linear-to-tr from-purple-600 to-electric-blue flex items-center justify-center text-white shadow-lg shadow-purple-500/20">
					...
					<div>
						...
						<p className="text-sm text-on-surface-variant mt-2 max-w-sm mx-auto leading-relaxed">
							{getFeatureMessage()} Get Orchest Pro for just{" "}
							<span className="text-white font-semibold">$9/month</span> to keep
					...
					<div className="w-full bg-surface-container-low/50 rounded-xl border border-border-low p-4 text-left flex flex-col gap-3">
						...
						<div className="flex justify-between items-center text-xs">
							...
							<div className="flex gap-4 font-semibold">
								<span className="w-12 text-center text-on-surface-variant/70">
									3/mo
								</span>
						...
						<div className="flex justify-between items-center text-xs">
							...
							<div className="flex gap-4 font-semibold">
								...
								<span className="w-12 text-center text-purple-400">
									Priority
								</span>
							</div>
						</div>
					...
					<div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
						...
						<Button
							type="button"
							className="flex-1 bg-linear-to-r from-purple-600 to-electric-blue hover:from-purple-500 hover:to-blue-400 border-none text-white order-1 sm:order-2 flex justify-center items-center gap-2"
